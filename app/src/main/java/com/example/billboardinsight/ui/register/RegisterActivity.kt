...
import com.example.billboardinsight.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun setEmailValidation() {
        registerViewModel.updateEmailStatus(binding.emailCustom.valid)
    }

    private fun setPasswordValidation() {
        registerViewModel.updatePasswordStatus(binding.passwordCustom.valid)
    }
        ...
        when (v?.id) {
            R.id.btn_register -> {
                registerViewModel.registerUser(
                    binding.nameCustom.text.toString(),
